...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of OpenAttestationIOS.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Tan Cher Shen/OpenAttestationIOS'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Tan Cher Shen' => 'tan_cher_shen@tech.gov.sg' }
  s.source           = { :git => 'https://github.com/Tan Cher Shen/OpenAttestationIOS.git', :tag => s.version.to_s }
